...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        String expected0 = "fedcba";
        char expected1 = 'e';
        int expected2 = 6;
        String expected3 = "edc";

        assertThat(text.toString()).isEqualTo(expected0);
        assertThat(text.charAt(1)).isEqualTo(expected1);
        assertThat(text.length()).isEqualTo(expected2);
        assertThat(text.subSequence(1, 4).toString()).isEqualTo(expected3);
    }
    // END
}
